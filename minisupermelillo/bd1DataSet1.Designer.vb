    ...
    Partial Public Class ProductosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Productos] SET [codigo] = @codigo, [producto] = @producto, [descrip"& _ 
                ...
                "] = @Original_existencia));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, codigo, producto, descripcion, precio, e"& _ 
                "xistencia, imagen FROM Productos WHERE (id = @id)"
    ...
    Partial Public Class UsuariosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Username], [PasswordHash]) VALUES (@Username, @Pas"& _ 
                "swordHash);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Username, PasswordHash FROM Usuarios WHERE (Id = SCOPE_I"& _ 
                "DENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuarios] SET [Username] = @Username, [PasswordHash] = @PasswordHas"& _ 
                ...
                "ordHash] = @Original_PasswordHash));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Username, PasswordHash FROM Usu"& _ 
                "arios WHERE (Id = @Id)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
